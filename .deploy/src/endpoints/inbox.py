...
async def get_inbox(
    limit: int = Query(default=50, ge=1, le=100, description="Number of events to return (1-100)"),
    cursor: Optional[str] = Query(default=None, description="Pagination cursor (base64-encoded)"),
    source: Optional[str] = Query(default=None, min_length=1, description="Filter by source"),
    event_type: Optional[str] = Query(default=None, min_length=1, description="Filter by event type"),
